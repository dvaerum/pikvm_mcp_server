...
def main():
    ...
    v12_dists, v13_dists = [], []
    buckets = {
        "both_correct": [],       # v12 < 35 AND v13 < 35
        "v13_fixed_hallu": [],    # v12 >= 35 AND v13 < 35
        "v13_regressed": [],      # v12 < 35 AND v13 >= 35
        "both_hallucinate": [],   # v12 >= 35 AND v13 >= 35
    }
    ...
    for r in rows:
        ...
        buckets[bucket].append(r["frame_id"])
    ...
    print()
    print("=" * 70)
    summarize(v12_dists, "v12")
    summarize(v13_dists, "v13")
    print()
    ...
    print()
    print("failure buckets (threshold = 35 px):")
    ...
    print(
        f"\nVERDICT — v13 vs v12 on {n} held-out on-icon frames:\n"
        ...
        f"  N=34 is small; treat single-frame swings as noise."
    )
