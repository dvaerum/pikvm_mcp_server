"""
Export ml/cursor-v12.pt to ml/cursor-v12.onnx for onnxruntime-node consumption.
Architecture must match train-cursor-v12.py exactly.
"""
...
PT = ROOT / "cursor-v12.pt"
ONNX = ROOT / "cursor-v12.onnx"
