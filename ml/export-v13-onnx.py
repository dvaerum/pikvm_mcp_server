"""
Export ml/cursor-v13.pt to ml/cursor-v13.onnx for onnxruntime-node consumption.
Architecture must match train-cursor-v13.py exactly (identical to v12's net).
"""
...
PT = ROOT / "cursor-v13.pt"
ONNX = ROOT / "cursor-v13.onnx"
