"""
Export ml/cursor-v9-bordered.pt to ml/cursor-v9-bordered.onnx for onnxruntime-node consumption.

The v8 trainer didn't include ONNX export inline; this is a standalone
script. Architecture must match train-cursor-v9-bordered.py exactly.
"""
...
PT = ROOT / "cursor-v9-bordered.pt"
ONNX = ROOT / "cursor-v9-bordered.onnx"
